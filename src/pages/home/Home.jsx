  ...
  return (
    <>
      <main className="row w-100 h-100">
          ...
          >
            <div className="text-center text-white p-5">
              ...
              <p className="lead fs-3">
                Encuentra paquetes turísticos a los mejores destinos y precios
        ...
        {/* Paquetes */}
        <section className="col-12 p-5 border-top border-light" style={{ backgroundColor: "#eeeeee"}}>
                  ...
                  <div className="card h-100 shadow-sm">
                    <div className="card-body">
                      ...
                      <p className="card-text text-muted">
                        Para reservar un paquete, primero debes registrarte en
                        la aplicación, luego seleccionar el paquete que deseas y
        ...
        {/* Contacto */}
        <section id="contact" className="col-12 text-start p-5" style={{ backgroundColor: "#eeeeee"}}>
          <div className="container">
