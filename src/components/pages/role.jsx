export default function Role() {
  const array = ["Dashboard", "Gestión de roles", "Gestión de servicios", "Gestión de usuarios", "Gestión de reservas"]
            ...
            <fieldset>
                ...
                {array.map(
                    ...
                    <div key={index} className="flex items-center justify-between px-4 py-3 border-b">
                        ...
                        {[...Array(5)].map((_, idx) => (
                            <input key={idx} className="form-check-input" type="checkbox" id={`flexCheckDefault${idx}`} />
                        ))}
                        </div>
                    </div>
                    )
